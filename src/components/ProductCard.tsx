...
export function ProductCard({ product }: { product: Product | RecommendedProduct }) {
  ...
  return (
    <Link
      ...
      className="group h-full surface-card overflow-hidden flex flex-col transition-all duration-200 hover: hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
    >
